...
**Note**: The `npm` package manager is going to create a `node_modules` directory to install all of your dependencies. You shouldn't commit that directory. To avoid that, run the next command to create a [`.gitignore`](https://git-scm.com/docs/gitignore) file and add `node_modules` to it:
